    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button onClick={() => { resetForm(); setCreateOpen(true); }} className="bg-purple-700 hover:bg-purple-800 text-white rounded-xl shadow-sm shadow-purple-700/15 h-10 px-5 text-sm font-medium">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          {([
            ['all', 'All Meetings', 'bg-purple-50 text-purple-700'],
            ...
            <Card
              ...
              className={`p-4 rounded-xl cursor-pointer transition-all border ${filterStatus === key ? 'border-purple-300 bg-purple-50/30 shadow-md' : 'border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-slate-300'}`}
            >
        ...
        <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <div className="flex gap-2 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity flex-shrink-0">
                      ...
                      <Button
                        ...
                        className="rounded-lg text-xs border-slate-200 text-purple-600"
                      >
          ...
          {filteredMeetings.length === 0 && (
            <div className="text-center py-16">
              ...
              <Button onClick={() => { resetForm(); setCreateOpen(true); }} className="bg-purple-700 hover:bg-purple-800 text-white rounded-xl shadow-sm text-sm">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" onClick={selectAllStudents} className="text-xs text-purple-700 font-medium rounded-lg h-7">
                  ...
                  {courseStudents.map(student => (
                    <label
                      ...
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-all ${
                        selectedStudents.includes(student.id) ? 'bg-purple-50 ring-1 ring-purple-200' : 'hover:bg-white'
                      }`}
                    >
            ...
            {selectedStudents.length > 0 && formTitle && formLink && (
              <div className="p-3.5 bg-purple-50 rounded-xl border border-purple-100">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-semibold text-purple-700">Email Preview</span>
                </div>
                <div className="text-xs text-slate-600 space-y-1">
                  ...
                  <p className="pt-1"><span className="font-medium">Link:</span> <span className="text-purple-700">{formLink}</span></p>
                </div>
              </div>
            )}
            ...
            <div className="flex gap-2.5 justify-end pt-2">
              ...
              <Button onClick={handleCreateMeeting} className="bg-purple-700 hover:bg-purple-800 text-white rounded-xl text-sm shadow-sm">
          ...
          {selectedMeeting && (
            <div className="space-y-4 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="max-h-48 overflow-y-auto space-y-1 p-2 bg-slate-50 rounded-xl border border-slate-200">
                  {allEnrolledStudents.map(student => {
                    ...
                    return (
                      <label key={student.id} className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-all ${selectedStudents.includes(student.id) ? 'bg-purple-50 ring-1 ring-purple-200' : 'hover:bg-white'}`}>
                        <input type="checkbox" checked={selectedStudents.includes(student.id)} onChange={() => toggleStudent(student.id)} className="w-4 h-4 rounded accent-indigo-600" />
                        <img src={student.avatar} alt={student.name} className="w-7 h-7 rounded-full object-cover" />
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-slate-700 truncate">{student.name}</p>
              ...
              <div className="flex gap-2.5 justify-end pt-2">
                ...
                <Button onClick={handleSendEmail} className="bg-purple-700 hover:bg-purple-800 text-white rounded-xl text-sm shadow-sm" disabled={selectedStudents.length === 0}>
