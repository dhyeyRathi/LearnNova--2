-- LearnNova Initial Schema Migration
-- Created: 2026-03-22
-- Description: Creates all tables for the LearnNova LMS platform
...
CREATE TRIGGER update_kv_store_updated_at BEFORE UPDATE ON kv_store FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
